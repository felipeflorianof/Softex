...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger tr_ins_name before insert on users for each row set new.nome = upper(new.nome) */;;
DELIMITER ;
...
-- Dump completed on 2022-10-15  0:10:48
